...
plot(effdis$year,effdis$catch,xlab='',ylab='task 1 catch',type='l',lwd=3)
abline(v=seq(1950,2010,by=10),lty=2,col='blue')
plot(effdis$year,effdis$cpue,xlab='',ylab='task 2 cpue',type='l',lwd=3)
abline(v=seq(1950,2010,by=10),lty=2,col='blue')
plot(effdis$year,effdis$effort,xlab='',ylab='effort',type='l',lwd=3)
abline(v=seq(1950,2010,by=10),lty=2,col='blue')

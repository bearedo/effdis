...
subtitle: Instruction Manual for *effdisR*
Grmd::docx_document:
  fig_caption: yes
  force_captions: yes
---
...
```{r install effdis R library,eval=FALSE,include=FALSE,echo=TRUE}
install.packages('/path/to/package', repos = NULL, type="source")
```

```{r load effdis R library,eval=TRUE,include=FALSE,echo=TRUE}
library(effdisR)
```
